...
public class Categoria implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8368037156815837363L;

	@Id
	@GeneratedValue
	private Integer codigo;

	// many categories have one father category
	@ManyToOne
	@JoinColumn(name = "categoria_pai", nullable = true, foreignKey = @ForeignKey(name = "fk_categoria_categoria"))
	private Categoria pai;

	// many categorias belong to one user
	@ManyToOne
	...
	// one father category has many children
